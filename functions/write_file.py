...
schema_write_file = {
    ...
    "function": {
        "name": "write_file",
        "description": "Writes content to a specified file relative to the working directory, creating directories if necessary, and returns a success message or error",
        "parameters": {
            "type": "object",
            "properties": {
                "file_path": {
